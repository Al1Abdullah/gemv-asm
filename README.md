# SIMD Matrix-Vector Multiply Kernel

**x86-64 NASM · AVX2 + FMA**

![Assembly](https://img.shields.io/badge/x86--64_Assembly-000000?style=flat-square)
![AVX2](https://img.shields.io/badge/AVX2_FMA-000000?style=flat-square)
![C](https://img.shields.io/badge/C_Harness-000000?style=flat-square)
...
<sub>Raw numbers: <a href="results/benchmark_results.csv"><code>results/benchmark_results.csv</code></a></sub>
...
- **Small matrices** stay resident in L1/L2 cache, so the SIMD kernel is genuinely compute-bound and gets close to its theoretical 8x ceiling.
- **Large matrices** stop fitting in cache — both kernels become memory-bandwidth bound, spending more time waiting on loads than doing arithmetic, so vectorizing the arithmetic has less left to speed up.
